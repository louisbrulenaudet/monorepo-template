/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc` (hash: 75cff741842d1550f3db9a5a35ab5287)
// Runtime types generated with workerd@1.20260828.1 2026-08-11 
interface __BaseEnv_Env {
	ENVIRONMENT: "staging" | "production" | "dev";
	VITE_WORKER_API_BASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "VITE_WORKER_API_BASE_URL" | "VITE_API_BASE_URL">> {}
}
