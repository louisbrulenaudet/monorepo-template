...
- [#28](https://github.com/louisbrulenaudet/monorepo-template/pull/28) [`44c56cf`](https://github.com/louisbrulenaudet/monorepo-template/commit/44c56cff747a9c694a311f8668fa814c9b756577) Thanks [@louisbrulenaudet](https://github.com/louisbrulenaudet)! - Fix React Doctor maintainability and accessibility warnings: hoist static variant maps to module scope in `Button` and `Card`, and drop a redundant `role="img"` on logo images.
