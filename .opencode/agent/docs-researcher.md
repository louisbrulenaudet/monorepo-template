...
- Prefer the version this repo pins (check the relevant `package.json` / `wrangler.jsonc` before answering version-sensitive questions, e.g. Zod 4, TypeScript 7 rc, the pinned `@cloudflare/*` versions).
