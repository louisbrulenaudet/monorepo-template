...
# haiku: run fixers + parse the residual diagnostics into file:line is mechanical. No Write/Edit — every on-disk change comes from oxfmt/oxlint --fix, so the model itself can't hand-suppress a rule to pass.
model: haiku
color: yellow
---
