...
- **Only the GitHub Release is ours to write** - created/updated in-workflow with `gh release create --verify-tag`, with the matching `apps/worker-api/CHANGELOG.md` section appended when present.
