...
`wrangler.jsonc` is the **source of truth** for a Worker's bindings, vars, and routes. Generated outputs must never be hand-edited (see [guardrails.md](guardrails.md)):
