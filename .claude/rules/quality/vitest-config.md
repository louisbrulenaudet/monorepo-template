...
- Vitest 5: leave reporters unset so agent / CI auto-detection selects the reporter
...
4. Node factory only: environment node, pool threads, isolate false, fsModuleCache (stable top-level option since Vitest 5). Never attach cloudflareTest.
